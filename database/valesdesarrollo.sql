...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 24-10-2020 a las 04:43:07
...
CREATE TABLE `avales` (
  ...
  `Folio_INE` char(13) DEFAULT NULL,
...
CREATE TABLE `users` (
  ...
  `type_of_user` char(1) COLLATE utf8mb4_unicode_ci DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
--
ALTER TABLE `avales`
  ADD CONSTRAINT `AvaltoCliente_FK` FOREIGN KEY (`iD_Cliente`) REFERENCES `clientes` (`iD_Cliente`);
COMMIT;
